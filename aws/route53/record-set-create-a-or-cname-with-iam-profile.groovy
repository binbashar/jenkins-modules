...
def call(jenkins_modules_path, dns_record_set_comment, dns_record_set_type,dns_hosted_zone_id,
            aws_region, dns_record_set_name, dns_record_set_value, aws_iam_profile) {
