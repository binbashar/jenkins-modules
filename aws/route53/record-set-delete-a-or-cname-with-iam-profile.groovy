#!/usr/bin/env groovy
/**
 * Jenkins Modules: Delete DNS Record on AWS Route53.
 *
 ...
 * @param aws_iam_profile           DNS record set value
 */

def call(jenkins_modules_path, dns_record_set_comment, dns_record_set_type, dns_hosted_zone_id,aws_region,
            dns_record_set_name, dns_record_set_value, aws_iam_profile) {

    try {
        sh "#!/bin/bash \n" +
                "fab -f ${jenkins_modules_path}/python/jenkins_dns_aws_route53.py -R local" +
